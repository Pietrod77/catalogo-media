...
on open theItems
	...
	repeat with anItem in theItems
		...
		try
			set risultato to do shell script "cd " & quoted form of radice & " && venv/bin/python scripts/rinomina_batch.py " & quoted form of inputPath & " " & quoted form of outputPath & " modelle"
...
on run
	display dialog "Trascina una cartella di foto sopra questa app per rinominarle in base al riconoscimento volti (database Modelle)." buttons {"OK"} default button "OK"
end run
